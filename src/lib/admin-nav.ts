...
export const ADMIN_NAV: AdminNavGroup[] = [
  {
    ...
    items: [
      ...
      { slug: "con-so", label: "Con số nổi bật", icon: "🔢" },
      ...
      { slug: "tinh-nguyen-vien", label: "Tình nguyện viên", icon: "🙌" },
      { slug: "tai-tro", label: "Nhà tài trợ", icon: "🤝" },
      { slug: "ban-to-chuc", label: "Ban tổ chức", icon: "👥" },
      { slug: "dong-gop", label: "Đóng góp", icon: "💝" },
      { slug: "cam-nhan", label: "Cảm nhận", icon: "💬" },
